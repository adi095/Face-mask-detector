...
for file in os.listdir(r'D:/programs/FACEMASKDETECTOR/annotations/'):
    row = []
    xml = et.parse(r'D:/programs/FACEMASKDETECTOR/annotations/'+file) 
    root = xml.getroot()
    img = root[1].text
    row.append(img)
...
image_directories = sorted(glob.glob(os.path.join(r'D:/programs/FACEMASKDETECTOR/images/',"*.png")))
j=0
